...
staff = HospitalStaffFactory.create_staff(
    StaffType.DOCTOR, name="Alice", staff_id=101, specialization="Cardiology"
)
print(staff.get_details())

# Output:
# Doctor Alice (ID: 101) - Specialization: Cardiology
